...
PROFILES = [
    ...
    dict(id="huawei_iot_gateway", category="iot_gateway", label="Huawei industrial IoT gateway",
         vendors=[r"Huawei"], host="huawei-iot",
         beacons=["garp", "dhcp", "lldp", "mqtt", "dns_checkin", "tls_checkin"],
         dhcp_class="HUAWEI-IoT-Gateway", mdns=[], ssdp_st=None,
         checkin=["iot-device-management.huaweicloud.com"]),
